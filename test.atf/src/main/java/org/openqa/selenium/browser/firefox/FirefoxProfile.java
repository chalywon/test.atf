...
package org.openqa.selenium.browser.firefox;

import static org.openqa.selenium.browser.firefox.FirefoxDriver.ACCEPT_UNTRUSTED_CERTIFICATES;
import static org.openqa.selenium.browser.firefox.FirefoxDriver.ASSUME_UNTRUSTED_ISSUER;
import static org.openqa.selenium.browser.firefox.FirefoxDriver.DEFAULT_ENABLE_NATIVE_EVENTS;
...
import org.openqa.selenium.browser.firefox.internal.ClasspathExtension;
import org.openqa.selenium.browser.firefox.internal.Extension;
import org.openqa.selenium.browser.firefox.internal.FileExtension;
...
public class FirefoxProfile {
  ...
  private static final String defaultPrefs = "/com/atf/selenium/browser/firefox/webdriver.json";
   ...
   * called once per instance of the {@link com.atf.refer.selenium.browser.firefox.FirefoxDriver}.
   *
