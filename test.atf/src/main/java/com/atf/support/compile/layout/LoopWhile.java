 ...
 * @author charlse
 * @version
 * @time 2017年3月28日 下午5:35:10
 * @desption
 */
public class LoopWhile extends AbstractLayout implements  Compment {

	protected String _condition;

	public LoopWhile(String condition) {
	...
	public String _def() {
		...
		def.append(this.getIndent().substring(0, this.getIndent().length() - 4)+Keyword.WHILE + Symbol.BRACKETS + Symbol.BRACE);
