...
public class StringUtils {  
   ...
   public static List<String> spliteString(String sourceString,String splitor){
       String temp;
       List<String> list=new ArrayList<String>();
       while(sourceString.indexOf(splitor)!=-1){
           temp=sourceString.substring(0,sourceString.indexOf(splitor));
           list.add(temp);
           sourceString=sourceString.substring(sourceString.indexOf(splitor)+1);
       }
       list.add(sourceString);
       return list;
   }
   
   public static String getFileName(String path,boolean extend){
       String fileName="";
       List<String> list=spliteString(path,"/");
       fileName=list.get(list.size()-1);
       if(!extend){
           list=spliteString(fileName,".");
           String extendName=list.get(list.size()-1);
